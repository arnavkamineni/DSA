...
//		System.out.println(prime(100000));
		System.out.println(longestCollatz(10));
	}
	...
	public static int longestCollatz(int n) {
		...
		for( int i = 1; i < n+1; i++ ) {
			max_num = Math.max(max_num, LCH(i, memo, 0)); //get the maximum length for all numbers in range 1 - n
		}
		return max_num;
	}
